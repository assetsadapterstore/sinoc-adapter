...
func TestSubscribeAddress_SINOC(t *testing.T) {

	var (
		endRunning = make(chan bool, 1)
		symbol     = "SINOC"
		addrs      = map[string]string{
			"0x532e703b62484e0f330b3bdb9a2e748a2e12eedf": "sender",
			//"0xcbf3d0b6562b7ed887f36a2083fb5f14b9136124": "receiver",
		}
	)
	...
	//scanner.SetRescanBlockHeight(95103)
